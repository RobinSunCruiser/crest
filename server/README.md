...
The CREST Server provides the backend, handling communication with various language models, user authentication, and evaluation metrics. It serves as the central hub for processing requests from the client application and managing connections to different LLM providers.
...
The tool was created by Dr.-Ing. Robin Nicolay, Felix Gratzkowski and Dr.-Ing. Sebastian Bader at the University of Rostock.
