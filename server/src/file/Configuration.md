...
The CREST configuration system uses a JSON structure to manage all aspects of the application's behavior. This document explains each configuration section, available options, and how to modify them for your needs.
