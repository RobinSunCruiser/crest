...
import { CONNECTION_TYPES, EVENTS, SocketMessage, UnauthorizedMessage } from "./apiObjects";
  ...
  public received(message: SocketMessage): void {
    ...
    try {
      if (!this.authenticated) {
        ...
        // Send unauthorized response to trigger client login
        const unauthorizedResponse: UnauthorizedMessage = {
