...
import { checkForThinkingBlock, removeThinkingBlock } from "../../utils/strings";
import { IEmbeddingConfig, IModelCosine, IModelEmbedding } from "../../interfaces";
 ...
 */
export const evaluate = async (connection: Connection, message: LLMEvalMessage) => {
...
const getEmbeddings = async (
  ...
  for (const embeddingID in embeddingsConfig) {
    ...
    const embeddings = await adapter.getEmbeddings(config.model, messages, timeout);
