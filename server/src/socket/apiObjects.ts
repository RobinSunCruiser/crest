 ...
 */
export interface UnauthorizedMessage extends SocketMessage {
  event: EVENTS.UNAUTHORIZED;
  version: "0.1.0";
  data: {
    /** Error message explaining the unauthorized access */
    message: string;
  };
}
...
export interface LLMChatMessage extends SocketMessage {
  ...
  payload: {
    ...
    /** Optional batch context for analysis tracking - generic payload passed through */
